    ...
    <div name="pricing" className="w-full text-white my-16 md:my-24">
      ...
      <div className="max-w-[1240px] mx-auto py-12">
        <div className="text-center py-8 text-slate-300">
          ...
          <h3 className="text-4xl md:text-5xl font-bold text-white py-8 tracking-[.05em]">
        ...
        <div className="grid md:grid-cols-2">
          <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
            ...
            <div>
              <p className="text-5xl md:text-6xl font-bold py-4 flex">
                $70
            ...
            <div className="text-2xl  text-gray-600">
              <p className="flex py-4 text-xl md:text-2xl">
