      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 px-2 text-center">
          <div className="border py-8 rounded-xl shadow-xl">
            <p className="text-4xl md:text-6xl font-bold text-indigo-600">100%</p>
            <p className="text-gray-600 mt-2 text-xl">Completion</p>
          </div>
          <div className="border py-8 rounded-xl shadow-xl">
            <p className="text-4xl md:text-6xl font-bold text-indigo-600">24/7</p>
            <p className="text-gray-600 mt-2 text-xl">Delivery</p>
          </div>
          <div className="border py-8 rounded-xl shadow-xl">
            <p className="text-4xl md:text-6xl font-bold text-indigo-600">100K</p>
            <p className="text-gray-600 mt-2 text-xl">Transactions</p>
          </div>
        </div>
      </div>
    </div>
