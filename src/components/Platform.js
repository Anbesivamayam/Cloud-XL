  ...
  return (
    <div name="platform" className="w-full my-16 md:my-32 openSans">
      <div className="max-w-[1240px] mx-auto px-6">
        ...
        <p className="text-xl md:text-2xl py-4 md:py-8 text-gray-600 text-center leading-snug tracking-[.08em]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-4 pt-4">
          <div className="flex bg-white rounded-xl shadow-xl mx-auto px-6 border">
            <div>
              ...
              <p className="text-xl md:text-base text-gray-600 pt-2 pb-4 leading-loose">
          ...
          <div className="flex bg-white rounded-xl shadow-xl px-4 border">
            <div>
              ...
              <p className="text-xl md:text-base text-gray-600 pt-2 pb-4 leading-loose">
                ...
                stronger connections and business modules.
              </p>
            </div>
          </div>
          <div className="flex bg-white rounded-xl shadow-xl mx-auto px-6 border">
            <div>
              ...
              <p className="text-xl md:text-base text-gray-600 pt-2 pb-4 leading-loose">
                ...
                our audience data to target visitors on your site with customization
              </p>
            </div>
          </div>
          <div className="flex bg-white rounded-xl shadow-xl mx-auto px-6 border">
            <div>
              ...
              <p className="text-xl md:text-base text-gray-600 pt-2 pb-4 leading-loose">
              Create stronger connections with your customers from day 1 with our Marketing CRM tools.To make contact management easy.
              </p>
            </div>
          </div>
          <div className="flex bg-white rounded-xl shadow-xl mx-auto px-6 border">
